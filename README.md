...
***token is used to store a key for client side verifaction***

- [ ] What steps can you take in your web apps to keep your data secure?

***you can require a token. make sure you dont put data on local storage. use a seperate server to hold any data.***

- [ ] Describe how web servers work.

***web servers hold the files that make up website and applications then you can request those files which then render over http . this is the basis of the internet***
...
- **[POST]** \* to `/api/login`: returns a token to be added to the header of all other requests. Pass in the following credentials as the `bodyLambda School'` of the request: `{ username: ', password: 'i<3Lambd4' }`
